...
gulp.task('default', function(){
	gulp.watch('source/scss/**/*.scss', ['sass-ecoife', 'rtl-ecoife', 'build-js', 'build-js-css']); 
})

//gulp.task('develop', gulp.series('sass-ecoife', 'rtl-ecoife'))


//Task 1 - scss to css
gulp.task('sass-ecoife', function(){
	return gulp.src(
		[
		'source/scss/**/*.scss',
		]
